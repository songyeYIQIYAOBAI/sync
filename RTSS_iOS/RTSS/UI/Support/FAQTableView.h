...
#include "RTSSAppDefine.h"
/**
 *  FAQTableView is a custom table view class extended from UITableView class. This class provides a single-level hierarchical
 ...
 *  Main rows of your table view, which can be expandable or not must be instances of FAQTableViewCell class. Subrows can be
 *  instances of any class that is extended from UITableViewCell.
 */

@class FAQTableView;

#pragma mark - FAQTableViewDelegate

@protocol FAQTableViewDelegate <UITableViewDataSource, UITableViewDelegate>
 ...
 *
 *  @param tableView The instance of FAQTableView class which delegate is set.
 *
 ...
 *
 *  @param tableView The instance of FAQTableView class which delegate it set.
 *
 ...
 *
 *  @discussion In order to implement FAQTableView class efficiently, your content for the data source of the table view should
 *                  be designed as:
 *
 ...
 */
- (UITableViewCell *)tableView:(FAQTableView *)tableView cellForSubRowAtIndexPath:(NSIndexPath *)indexPath;
...
@interface FAQTableView : UITableView
/**
 * The delegate for the FAQTableViewDelegate protocol.
 *
 *  @discussion You must set only this protocol for the delegation and the datasource of FAQTableView instance.
 */
@property (nonatomic, retain) NSMutableArray                   *mResultsArr;//搜索结果
@property (nonatomic, retain) NSArray                          *tempResults;
@property (nonatomic, retain) UISearchDisplayController        *mSearchPlay;
@property (nonatomic, assign) BOOL                             isSearch;
@property (nonatomic, assign) id <FAQTableViewDelegate>        FAQTableViewDelegate;
...
@interface NSIndexPath (FAQTableView)<UISearchDisplayDelegate,UISearchBarDelegate>
